...
public function processReset()
{
    ...
    // Get ID from session (logged in) or temporary session (guest/forgot password)
    ...
    // IMPORTANT: Clear all sessions to force a fresh login
    session()->destroy(); 

    // Redirect to login with success message
    return redirect()->to('/login')->with('success', 'Password reset successfully! Please log in with your new password.');
}
    public function forgotPassword()
    {
        return view('borrower/forgot_password'); 
    }
