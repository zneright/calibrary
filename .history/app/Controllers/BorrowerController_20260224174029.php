    ...
    public function markNotificationsRead()
{
    if ($this->request->isAJAX()) {
        ...
        // Mark specific and general notifications as read for this user session context
        // Note: For 'all_users' target, you might want a junction table in a real app,
        // but for now, we'll just update notifications that mention this user.
