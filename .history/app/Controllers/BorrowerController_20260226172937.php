   ...
   public function catalog()
    {
        ...
        // 2. Setup Journals Query (FIXED: Now pulls the real 'status' column instead of hardcoding "AVAILABLE")
        ...
        // FIX: Apply the 'available' filter to Journals as well
        if ($status === 'available') {
    ...
    public function myBooks()
    {
        ...
        $data = array_merge($this->getNotificationData(), [
            ...
            // Ensure ALL rejected and closed statuses are pulled here
   ...
   public function markNotificationsRead()
{
    ...
    public function submitRequest()
    {
        ...
        // 1. Check if the item is still AVAILABLE in the collections table
        // 1. Check if the item is AVAILABLE or DAMAGED
        ...
        // ... proceed with your existing insert logic ...
