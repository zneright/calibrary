...
public function processReset()
{
    ...
    // 1. Identify the user (either logged in or via the Forgot Password flow)
    ...
    // 4. CLEANUP & REDIRECT
    session()->remove('temp_reset_user_id'); // Clear temp ID
    
    // If they were logged in, destroy session to force fresh login
    if (session()->get('id')) {
        session()->destroy(); 
    }
