...
{
    // Use notification data to keep the sidebar/header consistent
    $data = array_merge($this->getNotificationData(), [
        'title' => 'Verify Reset'
    ]);
...
public function processReset()
{
    ...
    // Check logged in ID first, then temp ID
    ...
    // If logged in, go to profile. If guest, go to login.
    ...
    public function sendPublicResetCode()
    {
        ...
        // IMPORTANT: Store the ID in session so the next page knows WHO is resetting
