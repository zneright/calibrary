   ...
   public function store()
{
    ...
    if ($targetAudience === 'all_users') {
        ...
        $rawInput = $this->request->getPost('user_id'); // "2026-001 | Renz Jericho"
        
        // Check if the input contains the separator from the datalist
        if (strpos($rawInput, ' | ') !== false) {
            ...
            // FALLBACK: If user only typed the ID, look up the name in the DB
