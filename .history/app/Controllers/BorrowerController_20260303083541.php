...
public function processReset()
{
    ...
    $this->logAction('Security', 'Reset', "Borrower successfully reset their password using email verification.");

    return redirect()->to('/borrower/profile')->with('success', 'Password reset successfully!');
}
