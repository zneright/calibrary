...
class Notifications extends BaseController
{
    ...
    public function delete()
    {
        ...
        // Fetch the notification first so we can log its details
        $notification = $model->find($id);

        if ($notification && $model->delete($id)) {
            ...
            $logModel->insert([
                ...
                'module'      => 'Notifications',
                'action'      => 'Delete',
                'details'     => "Deleted notification originally sent to: {$notification['recipient']}"
            ]);
