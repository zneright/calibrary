...
class Home extends BaseController
{
    public function index()
    {
        ...
        // Fetch the 5 newest items for the "New Acquisitions" sidebar
        $data['latest_books'] = $collectionModel->orderBy('id', 'DESC')->findAll(5);
        
        // Fetch 12 RANDOM items for the main feed before searching
        ...
        // Keep selected type as collections by default so the dropdown behaves correctly
