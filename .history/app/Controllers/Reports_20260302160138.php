...
class Reports extends BaseController
{
    public function index()
    {
        ...
        // if user clicked process report data button this will run
    ...
    $catList = implode(', ', $categories); // Converts array to string like "collections, journals"
    ...
    $logModel->insert([
        ...
        'module'      => 'Reports',
        'action'      => 'Generate',
        'details'     => "Admin ($adminName) generated a web report for: $catList."
    ]);
            //Collections Filter (Sorted Recent First)
            ...
            //Journals Filter (Sorted Recent First)
            ...
            //Transactions Filter (Sorted Recent First)
