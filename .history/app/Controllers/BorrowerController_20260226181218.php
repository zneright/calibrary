   ...
   public function updateProfile()
    {
        ...
        $rules = [
            ...
            // FIXED: Requires exactly 11 characters and strictly numbers only
            'contact'  => 'required|numeric|exact_length[11]' 
        ];

        // Custom error messages to make it clearer for the user
        $messages = [
            'contact' => [
                'numeric'      => 'Contact number must contain only numbers.',
                'exact_length' => 'Contact number must be exactly 11 digits long.'
            ]
        ];
