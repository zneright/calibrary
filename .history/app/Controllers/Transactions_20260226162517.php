...
class Transactions extends BaseController {
    ...
    public function approve() {
        ...
        if ($trans) {
            ...
            // 2. Change Book Status to Borrowed so it stops appearing available
            ...
            return redirect()->back()->with('success', 'Approved and email sent. Duplicates rejected.');
        }
    }
    ...
    public function processReturn() {
        ...
        if($trans) {
            ...
            // Re-open book in Collections table
    ...
    public function reportIssue() {
        ...
        if($trans) {
            ...
            // Mark the actual book as LOST or DAMAGED
