    ...
    private function generateHtml($data)
    {
        ...
        <head>
            <style>
                ...
                @page { margin: 40px 25px; } /* Reduced top margin since we aren't using fixed headers */
                footer { position: fixed; bottom: -20px; left: 0px; right: 0px; height: 40px; border-top: 1px solid #ddd; font-size: 10px; color: #777; padding-top: 5px; text-align: center; }
            </style>
        </head>
        <body>
            <div class="header">
        ...
        // ... [Include Journals and Transactions blocks as per your original code] ...

        $html .= '<footer>
                    Generated by CALIS v2.0 | Page <script type="text/php">echo $PAGE_NUM . " of " . $PAGE_COUNT;</script>
                  </footer>
                </body>
                </html>';
