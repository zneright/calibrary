...
class Logs extends BaseController
{
    ...
    public function exportPdf()
    {
        ...
        // 5. Build the HTML for the PDF using exact same styling as ExportReport
        $html = '
        <html>
        <head>
          <style>
        ...
        // Since Logs table is a bit dense, landscape is usually best, but you can change 'landscape' to 'portrait' if you prefer vertical!
        $dompdf->setPaper('A4', 'landscape');
        $dompdf->render();

        // --- LOG THE EXPORT ACTION BEFORE DOWNLOADING ---
