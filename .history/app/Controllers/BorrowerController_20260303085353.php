...
{
    // If not logged in, notification data will now return empty instead of crashing
    $data = array_merge($this->getNotificationData(), [
        'title' => 'Verify Reset'
    ]);
...
public function processReset()
{
    ...
    $redirect = session()->get('id') ? '/borrower/profile' : '/login';
    return redirect()->to($redirect)->with('success', 'Password reset successfully!');
}
