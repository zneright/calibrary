...
use App\Models\TransactionModel; // Added to sync transactions
...
class Collections extends BaseController
{
    ...
    public function update()
    {
        ...
        if ($collectionModel->update($id, $data)) {
            ...
            // --- SYNC WITH TRANSACTIONS IF BOOK IS LOST OR DAMAGED ---
            if (in_array($data['status'], ['LOST', 'DAMAGED'])) {
                ...
                // Convert 'LOST' to 'Lost' / 'DAMAGED' to 'Damaged' for transaction table
