...
// Ensure this specific POST route exists
$routes->post('admin/profile/process-reset', 'Profile::processReset');

// Also ensure the request code route is correct
$routes->post('admin/profile/request-reset-code', 'Profile::requestResetCode');

// And the GET route for the page itself
$routes->get('admin/verify-reset', 'Profile::verifyResetView');
    });
    // ==============================================
