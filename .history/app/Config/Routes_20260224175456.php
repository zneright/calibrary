...
$routes->group('borrower', static function ($routes) {
    ...
    $routes->get('notifications', 'BorrowerController::notificationsList'); 
    $routes->post('notifications/markRead', 'BorrowerController::markNotificationsRead');
    $routes->post('borrower/markNotificationsRead', 'BorrowerController::markNotificationsRead');
    $routes->get('borrower/notificationlist', 'BorrowerController::notificationlist');
$routes->post('borrower/markSingleRead/(:num)', 'BorrowerController::markSingleRead/$1');
});