...
// If your sidebar links to /admin/journals:
$routes->get('admin/journals', 'Journals::index');

// Actions (Add, Edit, Delete)
$routes->post('admin/journals/store', 'Journals::store');
$routes->post('admin/journals/update', 'Journals::update');
$routes->post('admin/journals/delete', 'Journals::delete');
    // Notifications
