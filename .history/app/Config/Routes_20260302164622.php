    ...
    $routes->get('reports/exportExcel', 'ExportReport::excel');
        ...
        $routes->post('auth/updateResetPassword', 'Auth::updateResetPassword');
        $routes->post('admin/profile/request-reset-code', 'Profile::sendResetLink');
        $routes->post('profile/request-reset-code', 'Profile::sendResetLink');
    });
