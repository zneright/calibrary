    ...
    $routes->get('reports/exportExcel', 'ExportReport::excel');
        ...
        $routes->post('request-reset-code', 'Profile::requestResetCode'); 
    
    // This matches: admin/profile/verify-reset
    $routes->get('verify-reset', 'Profile::verifyResetView');
    
    // This matches: admin/profile/process-reset
    $routes->post('process-reset', 'Profile::processReset');
    });
