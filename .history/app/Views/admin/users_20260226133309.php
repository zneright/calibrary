        ...
        <td>
            <div class="d-flex gap-1 justify-content-center">
                ...
                <?php if(($row['status'] ?? 'Active') == 'Active'): ?>
                    <button class="btn btn-danger btn-sm deactivate-user-btn" data-id="<?= $row['id'] ?>" title="Deactivate Account">
                        <i class="bi bi-person-x"></i>
                    </button>
                <?php else: ?>
                    <button class="btn btn-success btn-sm" onclick="reactivateUser(<?= $row['id'] ?>)" title="Reactivate">
