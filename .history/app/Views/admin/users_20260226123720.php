                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="me-3">
                                                <img src="<?= base_url('uploads/avatars/' . ($row['avatar'] ?: 'default.png')) ?>" 
                                                    class="rounded-circle border shadow-sm img-thumbnail user-avatar-zoom" 
                                                    style="width: 45px; height: 45px; cursor: zoom-in; object-fit: cover;"
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">
                                                    ...
                                                    <i class="bi bi-telephone"></i> <?= esc($row['contact'] ?? 'No Contact') ?> </small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-transparent border-0">
            <div class="modal-body p-0 text-center">
                ...
                <button type="button" class="btn btn-light mt-2 rounded-pill fw-bold" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
    ...
    <td class="text-start">
        <div class="d-flex align-items-center">
            <img src="<?= base_url('uploads/avatars/' . ($row['avatar'] ?: 'default.png')) ?>" 
                 ...
                 onclick="zoomThis(this.src)">
            <div>
                <strong><?= esc($row['fullname']) ?></strong><br>
        ...
        <td>
            <?php if($row['status'] == 'Active'): ?>
                <button class="btn btn-sm btn-outline-danger delete-user-btn" data-id="<?= $row['id'] ?>">Deactivate</button>
            <?php else: ?>
                <button class="btn btn-sm btn-outline-success" onclick="reactivateUser(<?= $row['id'] ?>)">Reactivate</button>
            <?php endif; ?>
        </td>
    </tr>
    </div>
