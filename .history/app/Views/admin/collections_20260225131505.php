...
$(document).ready(function () {
    ...
    // 1. ZOOM FUNCTION FIX
    // Use $(document).on to ensure it works on all DataTable pages
    ...
    // 2. EDIT & VIEW BUTTON LOGIC FIX
    $(document).on('click', '.view-btn, .edit-btn', function() {
        // Correctly parse the JSON data from the data-row attribute
        ...
        if (isEditMode) {
            ...
            // Set the correct route for update
