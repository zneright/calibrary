                    ...
                    <tbody class="align-middle text-center" style="font-size: 0.9rem;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ### 2. After the Handover Modal (The Renewal Modal)
                                Scroll down to where your `handoverModal` ends and paste this **Admin Renewal Modal**. It asks the admin for the new return date.
