                ...
                <table class="table table-bordered table-hover w-100" id="journalsTable">
                    <thead class="table-light align-middle text-center">
                        <tr>
                            ...
                            <th>SOURCE</th>
                            <th>VOL & PAGE</th>
                            <th>STATUS</th> <th width="120">ACTION</th>
                        </tr>
                    </thead>
...
$(document).ready(function () {
    ...
    // poen add new modal (auto clear)
    $('#openAddModalBtn').on('click', function() {
        $('#manage_id').val('');
        $('#manageForm')[0].reset(); // Clear all fields
        
        // Ensure status defaults to AVAILABLE on add
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $('#manage_status').val(rowData.status || 'AVAILABLE'); // Fill status
