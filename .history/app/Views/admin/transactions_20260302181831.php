...
<div class="container-fluid">
   ...
   <div class="d-flex justify-content-between align-items-center mb-4">
        <ul class="nav nav-pills bg-white p-1 rounded-pill shadow-sm border gap-1">
            <li class="nav-item">
                <a class="nav-link rounded-pill px-3 <?= !isset($_GET['status']) ? 'active fw-bold shadow-sm' : 'text-secondary' ?>" href="<?= base_url('admin/transactions') ?>">
                    All <span class="badge bg-secondary ms-1 small rounded-pill"><?= $counts['all'] ?></span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-pill px-3 <?= (isset($_GET['status']) && $_GET['status'] == 'Returned') ? 'active fw-bold shadow-sm' : 'text-secondary' ?>" href="<?= base_url('admin/transactions?status=Returned') ?>">
                    Returned <span class="badge bg-success text-white ms-1 small rounded-pill"><?= $counts['returned'] ?></span>
                </a>
            </li>
        </ul>
