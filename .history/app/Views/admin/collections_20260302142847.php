                        ...
                        <?php if (!empty($collections)): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php 
                                        $badge = 'bg-secondary';
                                        $currentStatus = strtoupper($row['status']); // Normalize the case for the logic check
...
$(document).ready(function () {
    ...
    // 2. PDF VIEWER FUNCTION
    window.viewPDF = function(url) {
        $('#pdfFrame').attr('src', url);
        $('#pdfViewerModal').modal('show');
    };

    // 3. REVIEW PDF BEFORE SAVING
