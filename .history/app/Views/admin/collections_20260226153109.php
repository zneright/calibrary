...
<datalist id="typeOptions">
    ...
    <?php if(!empty($types)): foreach($types as $t): ?><option value="<?= esc($t['type']) ?>"><?php endforeach; endif; ?>
</datalist>

<datalist id="readingOptions">
    <option value="General">
    <option value="Restricted">
    <?php if(!empty($readings)): foreach($readings as $r): ?><option value="<?= esc($r['reading']) ?>"><?php endforeach; endif; ?>
</datalist>
