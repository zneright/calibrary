            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover w-100" id="notificationTable">
                    ...
                    <tbody class="align-middle text-center" style="font-size: 0.9rem;">
                        <tr>
                            <td>1</td>
                            <td class="fw-semibold">User: 2024-0192</td>
                            <td><span class="badge bg-danger">Overdue Alert</span></td>
                            <td class="text-start">Please return "Data Structures" immediately. It is 2 days overdue.</td>
                            <td>Feb 18, 2026</td>
...
<button class="btn btn-danger btn-sm delete-notif-btn" 
    ...
    <i class="bi bi-trash"></i>
                        ...
                        <tr>
                            <td>2</td>
                            <td class="fw-semibold text-primary">All Admins</td>
                            <td><span class="badge bg-info text-dark">System Info</span></td>
                            <td class="text-start">Server maintenance scheduled for tonight at 11:00 PM.</td>
                            <td>Feb 18, 2026</td>
...
<div class="modal fade" id="addNotificationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form action="/notifications/store" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12" id="specificUserField" style="display: none;">
                            ...
                            <input type="text" name="user_id" id="userIdInput" class="form-control" placeholder="Enter User ID (e.g. 2024-0192)">
                        </div>
...
<div class="modal fade" id="deleteNotificationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow">
            ...
            <form action="<?= base_url('notifications/delete') ?>" method="POST">
                <?= csrf_field() ?>
...
$(document).ready(function () {
    ...
    // We use $(document).on so it works on all pages of the DataTable
