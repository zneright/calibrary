    ...
    <?php if($row['target_audience'] == 'specific_user'): ?>
        <div class="d-flex align-items-center">
            ...
            <div>
                <span class="fw-bold d-block"><?= esc($row['recipient']) ?></span>
                <small class="text-muted" style="font-size: 0.75rem;">Individual</small>
            </div>
        </div>
    <?php else: ?>
        <div class="d-flex align-items-center">
            ...
            <div>
                <span class="fw-bold d-block text-primary"><?= esc($row['recipient']) ?></span>
                <small class="text-muted" style="font-size: 0.75rem;">Group Broadcast</small>
            </div>
        </div>
    <?php endif; ?>
</td>
