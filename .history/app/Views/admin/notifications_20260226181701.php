        ...
        <form action="<?= base_url('admin/notifications/store') ?>" method="POST" class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                ...
                <div class="mb-3" id="specificUserField" style="display: none;">
                    ...
                    <input list="userList" name="user_id" id="userIdInput" class="form-control" placeholder="Type name or ID...">
                ...
                <div class="mb-0">
                    ...
                    <textarea name="message" class="form-control" rows="3" required placeholder="Type your notification message here..."></textarea>
                </div>
            </div>
