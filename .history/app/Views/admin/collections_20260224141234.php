                    ...
                    <tbody class="align-middle" style="font-size: 0.9rem;">
                        <?php if (!empty($collections)): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-light border text-danger delete-collection-btn" 
                                            title="Delete"
                                            data-id="<?= $row['id'] ?>"
...
$(document).ready(function () {
    $('#collectionTable').DataTable({
        ...
        "scrollY": "400px",
        "scrollCollapse": true,
        "order": [], // Stops the auto-sort!
        "language": { "emptyTable": "No collections found. The table is currently empty." }
    });

    // Reopen modal automatically if there's a validation error
