                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    if($status == 'Rejected' || $status == 'Lost' || $status == 'Damaged') $badge = 'bg-danger';
                                ?>
                                ...
                                <div class="d-flex gap-1 justify-content-center">
                                    ...
                                    <?php elseif($row['status'] == 'Borrowed'): ?>
                                        <form action="<?= base_url('admin/transactions/processReturn') ?>" method="POST">
                                            <?= csrf_field() ?><input type="hidden" name="id" value="<?= $row['id'] ?>">
                                            <button type="submit" class="btn btn-success btn-sm px-3 shadow-sm" title="Mark Returned"><i class="bi bi-check-circle"></i> Return</button>
                                        </form>
