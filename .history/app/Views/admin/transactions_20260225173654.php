...
<div class="container-fluid">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    if($status == 'Rejected' || $status == 'Extension Rejected') $badge = 'bg-danger';
                                ?>
                                ...
                                <div class="d-flex gap-1 justify-content-center">
                                    <?php if($row['status'] == 'Pending'): ?>
                                        <form action="<?= base_url('admin/transactions/approve') ?>" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-sm shadow-sm">Approve</button>
                                        </form>
    ...
    <div class="d-flex gap-1 justify-content-center">
        ...
        <button class="btn btn-outline-secondary btn-sm admin-renew-btn" data-id="<?= $row['id'] ?>" data-title="<?= esc($row['collection_title']) ?>">
