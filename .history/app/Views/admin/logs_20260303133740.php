                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="module" id="moduleFilter" class="form-select form-select-sm border-secondary">
                            ...
                            <option value="Authentication">Authentication</option> <option value="Reports">Reports</option> <option value="Transactions">Transactions</option>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="action" id="actionFilter" class="form-select form-select-sm border-secondary">
                            ...
                            <option value="Login">Login</option> <option value="Generate">Generate</option> <option value="Download">Download</option> <option value="Add">Add / Create</option>
...
$(document).ready(function () {
    ...
    // 3. Re-draw the table whenever a filter input changes!
    $('#startDate, #endDate, #moduleFilter, #actionFilter').on('change clear', function() {
        table.draw();
    });
});
</script>
