...
<div class="container py-5">
    ...
    <div class="d-flex gap-4 mb-3 ps-2">
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="filter1" value="All" <?= !isset($_GET['type']) || $_GET['type'] == 'All' ? 'checked' : '' ?>>
            <label class="form-check-label" for="filter1">All</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="filter2" value="Collections" <?= isset($_GET['type']) && $_GET['type'] == 'Collections' ? 'checked' : '' ?>>
            <label class="form-check-label" for="filter2">Books</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="filter3" value="Journal" <?= isset($_GET['type']) && $_GET['type'] == 'Journal' ? 'checked' : '' ?>>
