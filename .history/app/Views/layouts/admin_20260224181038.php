...
<div class="dropdown">
    <a class="nav-link dropdown-toggle d-flex align-items-center gap-2 text-decoration-none" href="#" role="button" data-bs-toggle="dropdown">
        <img src="<?= base_url('images/default-avatar.png') ?>" 
             alt="Admin" 
             class="rounded-circle border border-2 border-white shadow-sm" 
             style="width: 35px; height: 35px; object-fit: cover;">
        <span class="d-none d-sm-block fw-semibold text-dark"><?= session()->get('fullname') ?? 'Admin' ?></span>
    </a>        
    </div>
