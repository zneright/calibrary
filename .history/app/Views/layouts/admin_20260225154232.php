    ...
    <main id="main-content">
        ...
        <a class="nav-link dropdown-toggle d-flex align-items-center gap-2 text-decoration-none" href="#" data-bs-toggle="dropdown">
            ...
            <?php 
                ...
                // Check if file exists in the specific uploads folder
            ...
            ?>
            <img src="<?= $avatarSrc ?>" alt="Profile" class="rounded-circle shadow-sm" style="width: 38px; height: 38px; object-fit: cover; border: 2px solid #e2e8f0;">
        </a>        
