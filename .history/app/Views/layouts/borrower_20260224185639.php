...
<div id="toastContainer" class="position-fixed top-0 start-50 translate-middle-x mt-4" style="z-index: 9999;">
    <?php if (session()->getFlashdata('success')) : ?>
        <div class="alert alert-success border-0 shadow-lg d-flex align-items-center px-4 py-3 rounded-4" role="alert">
...
<nav class="navbar navbar-expand-lg navbar-custom sticky-top py-2">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center fw-bold text-primary fs-4" href="/borrower/dashboard">
            <i class="bi bi-book-half me-2"></i> CALIS
        </a>
            ...
            <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
                ...
                <div class="dropdown">
                    <a class="nav-link dropdown-toggle profile-pill d-flex align-items-center gap-2" href="#" data-bs-toggle="dropdown">
                        <img src="<?= base_url('images/default-avatar.png') ?>" alt="User" class="rounded-circle" style="width: 32px; height: 32px; object-fit: cover; border: 1px solid #e2e8f0;">
                        <span class="d-none d-sm-block fw-semibold text-dark pe-1 small"><?= session()->get('fullname') ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end mt-3 border-0">
                        <li><a class="dropdown-item" href="/borrower/profile"><i class="bi bi-person me-2 text-muted"></i> My Profile</a></li>
...
<script>
    // [Your existing notification/toast script here...]
</script>
</body>
</html>