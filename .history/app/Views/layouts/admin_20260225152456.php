          ...
          <div class="dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center gap-2 text-decoration-none" href="#" data-bs-toggle="dropdown">
                    ...
                    <?php 
                        ...
                        // Check if user has an avatar and if the file exists in the directory
                    ...
                    ?>
                    <img src="<?= $userImage ?>" alt="User Avatar" class="rounded-circle user-avatar shadow-sm" style="width: 38px; height: 38px; object-fit: cover;">
                </a>        
