    ...
    <main id="main-content">
        <header class="topbar d-flex justify-content-between align-items-center sticky-top shadow-sm">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="btn btn-light btn-sm border shadow-sm position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-bell text-secondary"></i>
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.6rem;">3</span>
                    </button>
                    
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="width: 320px;">
                        <li><h6 class="dropdown-header text-dark fw-bold">Notifications</h6></li>
                        <li>
                            <a class="dropdown-item d-flex align-items-start py-2" href="#">
                                <div class="bg-warning text-white rounded-circle d-flex justify-content-center align-items-center me-3 mt-1" style="width: 30px; height: 30px;">
                                    <i class="bi bi-clock-history"></i>
                                </div>
                                <div>
                                    <span class="d-block fw-semibold text-wrap">Overdue Book</span>
                                    <small class="text-muted text-wrap">"The Great Gatsby" is 2 days late.</small>
                                </div>
                            </a>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-center text-primary small fw-semibold" href="/admin/notifications">View All Notifications</a></li>
                    </ul>
                </div>
