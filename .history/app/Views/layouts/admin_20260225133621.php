...
<head>
    ...
    <style>
        ...
        /* Desktop Collapsed State Logic */
        #sidebar.collapsed { width: var(--sidebar-collapsed-width); }
        
        /* Hide text elements but keep the icon/logo visible */
        #sidebar.collapsed .nav-text, 
        #sidebar.collapsed .full-logo-text { 
        ...
        <header class="topbar d-flex justify-content-between align-items-center sticky-top shadow-sm">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-2">
                    <li><a class="dropdown-item rounded py-2" href="/admin/profile"><i class="bi bi-person-gear me-2"></i>Profile Settings</a></li>             
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item text-danger rounded py-2" href="/logout"><i class="bi bi-box-arrow-right me-2"></i>Log Out</a></li>
                </ul>
            </div>
        </header>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function toggleSidebar() {
            if (window.innerWidth >= 992) {
                // Desktop: Collapse and center the logo
                sidebar.classList.toggle('collapsed');
                mainContent.classList.toggle('expanded');
            } else {
                // Mobile: Show slide-in menu
