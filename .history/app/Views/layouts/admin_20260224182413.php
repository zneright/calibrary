...
<div class="container-fluid p-0">
    <nav id="sidebar" class="p-3 shadow">
        ...
        <a href="/admin/notifications"><i class="bi bi-bell me-2"></i> <span class="nav-text">Notifications</span></a>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="width: 320px; max-height: 450px; overflow-y: auto;">
                        ...
                        <?php endif; ?>
                        <li>
    <a class="dropdown-item text-center text-primary small fw-semibold" href="/admin/notificationlist">
