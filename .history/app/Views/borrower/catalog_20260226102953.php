                ...
                <div class="card-body p-4">
                    <form action="/borrower/catalog" method="GET">
                        ...
                        <div class="form-check mb-2">
                            ...
                            <label class="form-check-label small" for="typeBook">Collection</label>
                        </div>
                        <div class="form-check mb-2">
                ...
                <div class="card-body p-4 ms-2">
                    <div class="row align-items-center">
                        <div class="col-md-9 d-flex align-items-start">
                            ...
                            <div>
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25"><?= esc($item['status']) ?></span>
                                </div>
                       ...
                       <div class="col-md-3 text-md-end mt-3 mt-md-0">
                            ...
                            <?php elseif (strtoupper($item['status']) !== 'AVAILABLE'): ?>
