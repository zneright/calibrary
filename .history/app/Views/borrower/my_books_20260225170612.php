                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-muted small">
                                        <?= ($row['date_returned']) ? date('M d, Y', strtotime($row['date_returned'])) : '---' ?>
                                    </td>
                                    <td>
                                        <?php 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?= base_url('borrower/renew/submit') ?>" method="POST" class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4 text-center">
                <div class="mb-3"><i class="bi bi-calendar2-range text-primary" style="font-size: 3rem;"></i></div>
                <p class="mb-1 text-muted">Requesting extension for:</p>
