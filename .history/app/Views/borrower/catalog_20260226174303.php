                                ...
                                <div class="col-md-3 text-md-end mt-3 mt-md-0">
                                    ...
                                    <?php elseif ($itemStatus === 'DAMAGED'): ?>
                                        <button class="btn btn-outline-danger w-100 btn-sm fw-bold" 
                                            onclick="openRequestModal('<?= esc(addslashes($item['title'])) ?>', '<?= $item['id'] ?>', 'DAMAGED', '<?= $item['source_table'] ?>')">
                                    ...
                                    <?php else: ?>
                                        <button class="btn btn-outline-dark w-100 btn-sm fw-bold" 
                                            onclick="openRequestModal('<?= esc(addslashes($item['title'])) ?>', '<?= $item['id'] ?>', 'AVAILABLE', '<?= $item['source_table'] ?>')">
                                            Request Access
                                        </button>
                                    <?php endif; ?>
                                </div>
...
<script>
    // FIXED: Added sourceTable parameter to the Javascript function
    function openRequestModal(title, id, status, sourceTable) {
        
        document.getElementById('modalBookTitle').value = title;
        document.getElementById('modalBookId').value = id;
        document.getElementById('modalSourceTable').value = sourceTable; 
