                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-warning text-dark border border-warning border-opacity-50">Waiting for Approval</span></td>
                                    <td class="text-center pe-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            ...
                                            $badge = 'bg-secondary';
                                            if($st == 'returned') $badge = 'bg-success';
                                            if($st == 'rejected' || $st == 'cancelled') $badge = 'bg-danger';
                                        ?>
        ...
        <form action="<?= base_url('borrower/renew/submit') ?>" method="POST" class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4 text-center">
                ...
                <div class="alert alert-info small text-start border-0 shadow-sm">
                    <i class="bi bi-info-circle-fill me-2"></i>Once submitted, the Admin will review your request and set a new return date for you.
                </div>
            </div>
