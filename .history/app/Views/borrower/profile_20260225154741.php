            ...
            <div class="card shadow-sm border-0 text-center sticky-top" style="top: 80px;">
                <div class="card-body p-4">
                    <div class="mb-3 position-relative d-inline-block">
                        <?php 
                            $avatarPath = ($user['avatar'] && file_exists(FCPATH . 'uploads/avatars/' . $user['avatar'])) 
                    ...
                    <form action="/borrower/profile/update" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-end mt-4">
                                <button type="submit" class="btn text-white px-4" style="background-color: #1e3a8a;">Save Changes</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body p-4">
                    <form action="/borrower/profile/password" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-end mt-4">
                                <button type="submit" class="btn btn-dark fw-semibold">Update Password</button>
                            </div>
                        </div>
                    </form>
                </div>
