...
<head>
    ...
    <style>
        ...
        /* Modern Hover Effects added to make the UI feel better without changing layout */
    ...
    <div class="row g-5">
        <div class="col-lg-9">
            ...
            <?php if (isset($results) && !empty($results)): ?>
                ...
                <div class="card card-hover shadow-sm mb-3" onclick="openDetailsModal(<?= $bookJson ?>)">
        ...
        <div class="col-lg-3">
            ...
            <?php if(!empty($latest_books)): ?>
                ...
                <?php 
                    // Safely encode sidebar book for the modal!
                    $newBookJson = htmlspecialchars(json_encode($newBook), ENT_QUOTES, 'UTF-8'); 
                ?>
                <div class="mb-4 text-center p-3 rounded shadow-sm bg-light card-hover" onclick="openDetailsModal(<?= $newBookJson ?>)">
