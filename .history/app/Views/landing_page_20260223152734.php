...
<div class="container py-5">
    ...
    <div class="row align-items-center ca-header">
        <div class="col-md-1 text-center text-md-end">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Commission_on_Appointments_%28CA%29.svg/1200px-Commission_on_Appointments_%28CA%29.svg.png" alt="CA Logo" style="width: 80px;">
        </div>
            ...
            <form action="/home/search" method="GET">
                <div class="d-flex gap-4 mb-3 ps-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="filter1" checked>
                        <label class="form-check-label" for="filter1">Collections</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="filter2">
                        <label class="form-check-label" for="filter2">Journal</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="filter3">
                        <label class="form-check-label" for="filter3">Presidential Decree</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="filter4">
                        <label class="form-check-label" for="filter4">Executive Order</label>
                    </div>
                </div>
