...
<div class="container d-flex justify-content-center">
    <div class="card login-card p-2"> <div class="card-body p-4 p-sm-5">
            ...
            <form action="/login/attempt" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary">Username or ID</label>
                    <div class="input-group shadow-sm rounded">
                        <span class="input-group-text"><i class="bi bi-person"></i></span>
                        <input type="text" name="username" class="form-control" placeholder="Enter your ID" required autofocus>
                    </div>
                </div>
