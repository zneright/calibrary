...
<div class="container py-5">
    ...
    <?php if(!empty($newAcquisitions)): foreach($newAcquisitions as $new): ?>
        <div class="mb-4 text-center">
            <?php $img = !empty($new['cover_photo']) ? base_url('uploads/'.$new['cover_photo']) : 'https://via.placeholder.com/140x200?text=No+Cover'; ?>
            <img src="<?= $img ?>" class="img-fluid book-cover mb-2" style="max-width: 140px; height: 200px; object-fit: cover;" alt="Book">
            <h6 class="fw-bold mb-0 text-dark small text-uppercase"><?= esc($new['title']) ?></h6>
            <p class="text-muted small mb-0" style="font-size: 0.8rem;"><?= esc($new['author']) ?></p>
        </div>
