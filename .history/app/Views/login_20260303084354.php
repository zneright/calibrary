            ...
            <form action="/login/attempt" method="POST">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#forgotPasswordModal" class="text-decoration-none small text-primary fw-semibold">Forgot Password?</a>
                    </div>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4 pt-0">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted small">Enter your registered email address to receive a 6-digit verification code.</p>
                </div>

                <form action="<?= base_url('send-reset-code') ?>" method="POST" id="forgotPasswordForm">
                    <?= csrf_field() ?>
                    <div class="mb-4">
...
<script>
    // Optional: Show loading state on button click
