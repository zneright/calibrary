                                    ...
                                    <td class="border-light">
                                        <?php 
                                            ...
                                            if ($status == 'Borrowed' || $status == 'Renewing') { 
                                                ...
                                                $badgeClass = (strtotime($row['due_date'] ?? '') < strtotime($today ?? date('Y-m-d'))) ? 'bg-danger text-white' : 'bg-primary text-white';
                                            }
                                        ?>
                                        <span class="badge <?= $badgeClass ?> bg-opacity-75 px-3 py-2 rounded-pill fw-medium shadow-sm" style="font-size: 0.75rem;">
                                            <?= $status ?>
                                        </span>
                                    </td>
