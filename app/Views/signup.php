        ...
        <div class="card-body p-4 p-sm-5">
            ...
            <form action="/signup/store" method="POST">
               ...
               <div class="row g-3">
                 ...
                 <div class="col-sm-6">
                        <label class="form-label fw-semibold small text-secondary">ID Number <span class="text-danger">*</span></label>
                        <input type="text" name="user_id" class="form-control shadow-sm" placeholder="e.g. 2026-001" value="<?= old('user_id') ?>" required>
                    </div>
                    
                    <div class="col-sm-6">
                        <label class="form-label fw-semibold small text-secondary">Department <span class="text-danger">*</span></label>
                        <input type="text" name="department" class="form-control shadow-sm" placeholder="e.g. DBLS" value="<?= old('department') ?>" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label fw-semibold small text-secondary">Role <span class="text-danger">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <label class="form-label fw-semibold small text-secondary">Confirm <span class="text-danger">*</span></label>
